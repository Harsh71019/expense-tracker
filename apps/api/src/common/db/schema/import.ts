...
export const stagedRows = pgTable(
  "staged_rows",
  {
    ...
    suggestionCategoryId: uuid("suggestion_category_id").references(() => categories.id),
    suggestionConfidenceBps: integer("suggestion_confidence_bps"),
    suggestionMethod: text("suggestion_method"),
    suggestionEvidenceCount: integer("suggestion_evidence_count"),
    suggestionAlgorithmVersion: integer("suggestion_algorithm_version"),
