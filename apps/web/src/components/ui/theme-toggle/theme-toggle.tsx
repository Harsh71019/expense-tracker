  ...
  return (
    <form action={toggleTheme} className="w-full">
      <button
        ...
        className={`flex min-h-11 w-full items-center gap-2 rounded-lg border border-border bg-surface-elevated px-3 py-2 text-2xs font-bold text-foreground-muted transition-colors duration-150 hover:border-accent/40 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${compact ? "h-11 w-11 justify-center px-0" : ""}`}
      >
